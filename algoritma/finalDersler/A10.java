...
public class A10 extends JFrame {
	...
	public A10() {
	   ...
	   else if(sonuc==1) {int sn=a/b;  
	   JOptionPane.showMessageDialog(null, String.valueOf(sn));}
			
	 else if(sonuc==2) { JOptionPane.showMessageDialog(null, "İşlem İptal Edildi","İptal",2);}
	 else {JOptionPane.showMessageDialog(null, "Pencere Kapatıldı","Uyarı",0);}		
